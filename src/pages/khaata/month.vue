        ...
        <div class="col-12">
          ...
          >
            <template slot="header">
              ...
              <router-link to="month/addMonth" tag="button" class="btn btn-info">Add New Month</router-link>
          ...
          <th>Last Updated</th>
            ...
            <td>
             <router-link  :to="{path: 'months/detail/'+data.id}"
             tag="button" class="btn btn-warning btn-fill ">Details</router-link><br><br>
            </td>
